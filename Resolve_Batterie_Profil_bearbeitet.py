...
IPFensterLabel=Label(root,  text="localhost", fg="black", bg= "white")
IPFensterLabel.place(y=0, x=100, width= 200,height= 30)
    
PortFenster =Label(root,text = "502", fg="black", bg="white")
PortFenster.place(y=30, x=100, width= 200, height= 30)
...
def print_entry():
    ...
    print("Value before writing:" + str(server.data_bank.get_input_registers(168)))
    ...
    server.data_bank.set_input_registers(173, [counter])
    time.sleep(1)
    ...
    print("Server is run:" + str(server.is_run))  
    print("Value after writing:" + str(server.data_bank.get_input_registers(168)))
                  
    root.after(30000, print_entry) 
